...
| **`video_quality`** | `20` - `28` | **RF/CQ Value.** Controls quality. 
**Note:** The scale changes depending on the codec selected. <br>• **x264:** `20`-`23` is standard. <br>• **x265:** `24`-`28` is standard. <br>• **NVENC:** `23` is a safe starting point. <br>Lower number = Higher quality (larger file). |
